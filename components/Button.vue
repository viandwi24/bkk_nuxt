...
export default {
  props: {
    ...
    classInit: {
      type: String,
      default: 'button cursor-pointer rounded font-semibold transition-all duration-100 ease-in inline-block'
    },
    classBtn: {
      type: String,
      default: 'mx-1'
  ...
  computed: {
    classType () {
      ...
      switch (type) {
        case 'primary':
          newClass = 'text-gray-100 bg-blue-400 hover:bg-blue-600 hover:text-gray-300'
          break
        case 'success':
          newClass = 'text-gray-100 bg-green-400 hover:bg-green-600 hover:text-gray-300'
          break
        case 'warning':
          newClass = 'text-gray-100 bg-orange-400 hover:bg-orange-600 hover:text-gray-300'
          break
        case 'danger':
          newClass = 'text-gray-100 bg-red-400 hover:bg-red-600 hover:text-gray-300'
          break
        case 'transparant':
          newClass = 'text-gray-700 hover:bg-gray-300'
          break
        default:
          break
      }
